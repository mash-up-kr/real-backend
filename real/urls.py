...
from .views import DreamListCreateAPIView, DreamRetrieveUpdateDestroyAPIView, ResultRetrieveUpdateDestroyAPIView, \
...
urlpatterns = format_suffix_patterns([
    ...
    path('<int:pk>/result/', ResultRetrieveUpdateDestroyAPIView.as_view(), name='dream_detail'),
])
